...
import { ChangeDetectionStrategy, Component, EventEmitter, Input, Output, SimpleChange, OnChanges } from '@angular/core';
...
@Component({
  selector: 'pams-assigned-intake-task-list',
  templateUrl: './assigned-intake-task-list.component.html',
