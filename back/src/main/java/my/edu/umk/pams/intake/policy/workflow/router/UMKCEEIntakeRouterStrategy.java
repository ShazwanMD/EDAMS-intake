...
public class UMKCEEIntakeRouterStrategy extends RouterStrategySupport {
	...
	public List<String> findVerifierCandidates() {
		return Arrays.asList("GRP_ADM","GRP_ADM_UMKCEE","GRP_KRN_ADM_UMKCEE","GRP_PGW_ADM_UMKCEE",
				...
				"GRP_DKN_FCTY_A14", "GRP_TDKN_FCTY_A14"); // cps-kerani , root
	}
    ...
    public List<String> findPublisherCandidates() {
        return Arrays.asList("GRP_ADM","GRP_ADM_UMKCEE","GRP_KRN_ADM_UMKCEE","GRP_PGW_ADM_UMKCEE",
				...
				"GRP_DKN_FCTY_A08", "GRP_TDKN_FCTY_A08", "GRP_DKN_FCTY_A11", "GRP_TDKN_FCTY_A11",
				"GRP_DKN_FCTY_A12", "GRP_TDKN_FCTY_A12", "GRP_DKN_FCTY_A13", "GRP_TDKN_FCTY_A13",
				"GRP_DKN_FCTY_A14", "GRP_TDKN_FCTY_A14");   //cps-pegawai , root
    }
	...
	public List<String> findSelectorCandidates() {
		return Arrays.asList("GRP_ADM","GRP_ADM_UMKCEE","GRP_KRN_ADM_UMKCEE","GRP_PGW_ADM_UMKCEE",
				...
				"GRP_DKN_FCTY_A08", "GRP_TDKN_FCTY_A08", "GRP_DKN_FCTY_A11", "GRP_TDKN_FCTY_A11",
				"GRP_DKN_FCTY_A12", "GRP_TDKN_FCTY_A12", "GRP_DKN_FCTY_A13", "GRP_TDKN_FCTY_A13",
				"GRP_DKN_FCTY_A14", "GRP_TDKN_FCTY_A14"); // fakulti-kerani-A01 , root
	}
	...
	public List<String> findPreapproverCandidates() {
		return Arrays.asList("GRP_ADM","GRP_ADM_UMKCEE","GRP_KRN_ADM_UMKCEE","GRP_PGW_ADM_UMKCEE",
				...
				"GRP_DKN_FCTY_A08", "GRP_TDKN_FCTY_A08", "GRP_DKN_FCTY_A11", "GRP_TDKN_FCTY_A11",
				"GRP_DKN_FCTY_A12", "GRP_TDKN_FCTY_A12", "GRP_DKN_FCTY_A13", "GRP_TDKN_FCTY_A13",
				"GRP_DKN_FCTY_A14", "GRP_TDKN_FCTY_A14"); // fakulti-pegawai-A01 , root
	}
